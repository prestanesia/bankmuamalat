...
$cart = $context->cart;
$bankwire = Module::getInstanceByName('bankmuamalat');
...
$bankwire->validateOrder($cart->id, Configuration::get('PS_OS_BANKMUAMALAT'), $total, $bankwire->displayName, null, array(), (int)$currency->id, false, $customer->secure_key);
