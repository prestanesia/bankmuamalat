...
--------
Modul pembayaran Bank Muamalat untuk PrestaShop 1.6.x (branch: 1.6) dan PrestaShop 1.7.x (branch: master)
...
* Rename bankmuamalat-master.zip menjadi bankmuamalat.zip
